...
function handleLogoPointerEnter() {
  startLogoQuoteAnimation();
}
...
function handleLogoPointerLeave() {
  if (!logoQuote) {
    return;
  }
...
if (logoLink && logoQuote) {
  logoLink.addEventListener('mouseenter', handleLogoPointerEnter);
  logoLink.addEventListener('mouseleave', handleLogoPointerLeave);
  logoLink.addEventListener('focus', handleLogoFocus);
  logoLink.addEventListener('blur', handleLogoPointerLeave);
